...
from daceml.ort_ln import LayerNorm, LayerNormEnvironment
from daceml.ort_ln.manual import add_ln_tasklet_bwd
...
class ORTSoftmaxGrad(BackwardImplementation):
    ...
    def backward(
        ...
        shape = butils.forward_in_desc_with_name(forward_node, context, "_X").shape
        ...
        butils.connect_output_from_forward(forward_node, tasklet, context, "_inv_std_var")
        butils.connect_output_from_forward(forward_node, tasklet, context, "_mean")
